  ...
  <div class="hero_area">
    ...
    <header class="header_section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-8">
            <nav class="navbar navbar-expand-lg custom_nav-container fixed fixed-top ">
              ...
              <div class="row">
                <div class="col-lg-5 col-md-6">
                  <div class="slider_detail-box">
                    ...
                    <p>
                      Keep in touch with your clients and transfer money all around being assured that it's safe.
                    </p>
                    <div class="btn-box">
    ...
    <div class="container">
      ...
      <div class="service_container layout_padding2">
        <div class="service_box">
          <div class="img-box">
            <img src="images/transfer.jfif" height="279px" alt=""/>
          </div>
          <div class="detail-box">
            <h4>
              Transfer <br/>
        ...
        <div class="service_box">
            <div class="img-box">
                <img src="images/clients.jfif" height="279px" alt="" />
            </div>
          <div class="detail-box">
            <h4>
              View <br/>
        ...
        <div class="service_box">
            <div class="img-box">
                <img src="images/transactions.jfif" height="279px" alt="" />
            </div>
            <div class="detail-box">
                <h4>
                    View <br />
  ...
  <section class="why_section layout_padding">
    <div class="container">
      ...
      <div class="content-container">
          <p>
              We're in banking, but we're not bankers We don't wear suits and we don't see our clients on appointment only. We are passionate people who love what we do, and we contribute and work together as a team to achieve our purpose – to make banking simple and transparent so that our clients can live better.
          </p>
        <div class="row">
